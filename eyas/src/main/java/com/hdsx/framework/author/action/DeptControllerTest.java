package com.hdsx.framework.author.action;
...
//		@PathVariable用于地址栏使用{xxx}模版变量时使用
		...
		public String findOwner(@PathVariable/*("id")*/ String id, Model model,@ModelAttribute("createDept")Dept createDept) {
			Dept dept = deptSerivce.selectById(id);
